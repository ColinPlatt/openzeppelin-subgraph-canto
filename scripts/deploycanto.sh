...
set -xo errexit
  ...
  npx graph-compiler --config ~/openzeppelin-subgraph-canto/configs/live/canto/nfts.json --include ~/openzeppelin-subgraph-canto/subgraph/src/datasources --export-schema --export-subgraph
